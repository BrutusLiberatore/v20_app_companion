    ...
    fun sendMessage(message: LiveRoomMessage) {
        try {
            val jsonStr = when (message) {
                ...
                is LiveRoomMessage.PresentAsset -> json.encodeToString(LiveRoomMessage.PresentAsset.serializer(), message)
                is LiveRoomMessage.DismissAsset -> json.encodeToString(LiveRoomMessage.DismissAsset.serializer(), message)
